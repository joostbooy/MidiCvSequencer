...
static const uint8_t midi_page_16x16[] = {
	0x00, 0x00, 0x00, 0x00, 0xC0, 0x07, 0xF0, 0x1E, 0xF0, 0x16,
	0xF8, 0x3B, 0xF8, 0x3F, 0xC0, 0x27, 0xF8, 0x3F, 0xF8, 0x3B, 0xF0,
	0x16, 0xF0, 0x1E, 0xC0, 0x07, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
};

static const uint8_t cv_page_16x16[] = {
	0xE0, 0x0F, 0xE0, 0x0F, 0x40, 0x04, 0x40, 0x04, 0x40, 0x04,
	0x40, 0x04, 0x40, 0x04, 0x40, 0x04, 0xC0, 0x07, 0xC0, 0x07, 0x40,
	0x04, 0x80, 0x02, 0x40, 0x04, 0x40, 0x04, 0x40, 0x04, 0x80, 0x03,
};
...
static const uint8_t system_page_16x16[] = {
...
static const uint8_t random_page_16x16[] = {
	0xF0, 0x7F, 0x18, 0x80, 0xD4, 0xB0, 0xD2, 0xB0, 0x11, 0x80,
	0x11, 0x86, 0x11, 0x86, 0x15, 0x80, 0xD5, 0xB0, 0xD1, 0xB0, 0x11,
	0x80, 0xE1, 0x7F, 0x09, 0x40, 0x65, 0x2C, 0x03, 0x10, 0xFE, 0x0F,
};
...
void Bitmap::set(Bitmap::Id id) {
	...
	case Bitmap::PLACEHOLDER_PAGE:
		...
		bitmap.frames = 1;
		break;
	case Bitmap::MIDI_PAGE:
		bitmap.data = &midi_page_16x16[0],
		bitmap.width = 16;
		bitmap.height = 16;
		bitmap.frames = 1;
		break;
	case Bitmap::CV_PAGE:
		bitmap.data = &cv_page_16x16[0],
		bitmap.width = 16;
		bitmap.height = 16;
		bitmap.frames = 1;
		break;
	...
	case Bitmap::SONG_MONITOR_PAGE:
		...
		bitmap.frames = 1;
		break;
	case Bitmap::SYSTEM_PAGE:
		bitmap.data = &system_page_16x16[0],
		bitmap.width = 16;
		bitmap.height = 16;
		bitmap.frames = 1;
		break;
	case Bitmap::RANDOM_PAGE:
		bitmap.data = &random_page_16x16[0],
		bitmap.width = 16;
		bitmap.height = 16;
		bitmap.frames = 1;
		break;
