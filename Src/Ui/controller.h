...
public:
	...
	int8_t button_to_chapter(uint8_t id) {
		switch (id)
		{
		case SONG_CHAPTER_BUTTON:		return Chapter::SONG;
		case TRACK_CHAPTER_BUTTON:		return Chapter::TRACK;
		case PATTERN_CHAPTER_BUTTON:	return Chapter::PATTERN;
		case MIDI_CHAPTER_BUTTON:		return Chapter::MIDI;
		case CV_CHAPTER_BUTTON:			return Chapter::CV;
